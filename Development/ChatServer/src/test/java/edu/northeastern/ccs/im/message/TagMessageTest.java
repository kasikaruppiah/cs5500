...
class TagMessageTest {
  ...
  void dispatchValid() {
    ...
    assertTrue(MessageFactory.makeMessage(MessageType.TAG, username1, null).dispatch(clientRunnable));
  ...
  void dispatchInValid() {
    ...
    assertTrue(MessageFactory.makeMessage(MessageType.TAG, username3, null).dispatch(clientRunnable));
  }
}